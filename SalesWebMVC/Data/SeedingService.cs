...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Lucca Bolder", "bolder@gmail.com", new DateTime(1995, 6, 27), 1000.0, d1);
            Seller s2 = new Seller(2, "Ingrid Moreira", "moreira@gmail.com", new DateTime(1998, 02, 10), 3500.0, d2);
            Seller s3 = new Seller(3, "Thais Akanne", "akanne@gmail.com", new DateTime(1995, 04, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Karina Cordeiro", "cordeiro@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Bianca Pelitz", "pelitz@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Felipe Rossi", "rossi@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
